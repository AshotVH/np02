'use strict';
angular.module('histogramvd', []).component('histogramvd', {
    templateUrl: 'histogramvd/histogramvd.template.html',
    controller: ['$routeParams', '$scope', '$window', '$http', '$interval',
        function histogramvdController($routeParams, $scope, $window, $http, $interval) {
            ...
            this.dayChanger = function (fundays) {
                $window.location.href = "#!/histogramvd/" + this.elemId + "/" + fundays;
            };

            this.range = function (start, end) {
                $window.location.href = "#!/histogramvdrange/" + this.elemId + "/" + start + "/" + end;
            };

            this.average = function () {
                $window.location.href = "#!/histogramvdaverage/" + this.elemId + "/" + fundays;
            };
            ...
            this.reload = function () {
                ...
                $http.get("php-db-conn/histogramvd.conn.php?elemId=" + self.elemId + "&days=" + fundays).then(function onSuccess(response) {
                    //if (response != undefined && typeof response == "object") {
                    console.log(elemName.data);
                    var title = elemName.data;   // what a freaking genius.
