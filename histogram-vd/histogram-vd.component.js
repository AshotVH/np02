'use strict';
angular.module('histogram-vd', []).component('histogram-vd', {
    templateUrl: 'histogram-vd/histogram-vd.template.html',
    controller: ['$routeParams', '$scope', '$window', '$http', '$interval',
        function histogramvdController($routeParams, $scope, $window, $http, $interval) {
            ...
            this.dayChanger = function (fundays) {
                $window.location.href = "#!/histogram-vd/" + this.elemId + "/" + fundays;
            };

            this.range = function (start, end) {
                $window.location.href = "#!/histogram-vdrange/" + this.elemId + "/" + start + "/" + end;
            };

            this.average = function () {
                $window.location.href = "#!/histogram-vdaverage/" + this.elemId + "/" + fundays;
            };
            ...
            this.reload = function () {
                ...
                $http.get("php-db-conn/histogram-vd.conn.php?elemId=" + self.elemId + "&days=" + fundays).then(function onSuccess(response) {
