...
angular.module("histogram", []).component("histogram", {
  ...
  controller: [
    ...
    function histogramController(
      ...
      $scope.isDataTableVisible = false;
      ...
      this.range = function (start, end) {
        $window.location.href =
          "#!/histogramrange/" + this.elemId + "/" + start + "/" + end;
      ...
      this.reload = function () {
        ...
        $http
          .get("php-db-conn/getname.php?elemId=" + self.elemId)
        ...
        $http
          ...
          .then(function onSuccess(response) {
            ...
            if (self.days < 0.35) {
              ...
              if (
                self.elemId === "47363557163291" ||
                self.elemId === "47363691381019" ||
                self.elemId === "47363607494939"
              ) {
                Highcharts.chart("container", {
                  chart: {
                    zoomType: "xy",
